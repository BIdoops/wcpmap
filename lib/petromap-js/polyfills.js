...
/* harmony import */ var core_js_es_promise__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/es/promise */ "./node_modules/core-js/es/promise/index.js");
...
var animateFn = Element.prototype.animate;
var isNativeImpl = /\{\s*\[native\s+code\]\s*\}/.test(animateFn.toString());

if (!isNativeImpl) {
  // @ts-ignore
  Element.prototype.animateOld = Element.prototype.animate;

  Element.prototype.animate = function (a, d) {
    return this.animateOld.call(this, a, d, '{ [native code] }');
  };
}
/**
